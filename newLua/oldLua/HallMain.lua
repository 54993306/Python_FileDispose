...
function HallMain:showFreeEffect()
    if IsPortrait then -- TODO
        ...
        --加载特效图
        cc.SpriteFrameCache:getInstance():addSpriteFrames("real_res/1008034.plist")
        ...
        --粒子效果
        self.btn_diamond.particleSys = cc.ParticleSystemQuad:create("real_res/1008035.plist");
