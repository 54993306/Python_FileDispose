...
--============================================================
local GamePlayLayer     = require("package_src.games.maomingmj.ui.gamelayer.BranchGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.maomingmj.system.BranchSystemManager").new()
