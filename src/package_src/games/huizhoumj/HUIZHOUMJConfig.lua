...
require("package_src.games.huizhoumj.custom.huizhoumjConstants")
...
GC_GameFiles = {
    ...
    game = {
		"package_src.games.huizhoumj.games.ui.gameover.FriendOverView",
		"package_src.games.huizhoumj.games.ui.gameover.FriendTotalOverView",
        },
