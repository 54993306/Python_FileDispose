...
function DropDownBox:initData()
    ...
    {
        BoxNormal = "package_res/games/gaozhoumj/friendRoom/drop_down_box_bg.png",
        IconNormal = "package_res/games/gaozhoumj/friendRoom/handle_down.png",
        IconShow = "package_res/games/gaozhoumj/friendRoom/handle_up.png",
    }
    --  文本参数
    self.m_parLabel =
    {
...
function DropDownBox:initUI()
    ...
    self.m_btnBox:setPosition(cc.p(0, lLayoutSize.height * 0.5 - 1))
