...
GC_GameFiles = {
    ...
    game = {
        --"package_src.games.gaozhoumj.games.MJFanMa",
        --"package_src.games.gaozhoumj.games.mediator.MjMediator",
        "package_src.games.gaozhoumj.games.ui.gameover.gaozhoumjFriendOverView",
        "package_src.games.gaozhoumj.games.ui.gameover.gaozhoumjFriendTotalOverView",
        },
}
