...
--Date
--此文件由[BabeLua]插件自动生成
local GamePlayLayer     = require("package_src.games.guangdongzptdhmj.games.ui.gamelayer.guangdongzptdhmjGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.guangdongzptdhmj.system.BranchSystemManager").new()
