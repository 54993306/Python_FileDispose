...
GC_GameFiles = {
    ...
    game = 
    {
     	"package_src.games.guangdongzptdhmj.games.ui.gameover.guangdongzptdhmjFriendOverView",
    	"package_src.games.guangdongzptdhmj.games.ui.gameover.guangdongzptdhmjFriendTotalOverView",
    },
}
