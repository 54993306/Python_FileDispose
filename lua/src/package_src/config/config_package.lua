...
elseif _SERVER_CHOICE == "正式服" then
	...
	G_Config = {
		...
		SLB_Servers = {
			{IP = "guangdong-region.stevengame.com", PORT = 30000, }, -- SLB-A
			{IP = "guangdong-region-bak.stevengame.com", PORT = 30000, }, -- SLB-B
		},
		-- 高防服务器
		GF_Servers = {
			{IP = "ddos-mj.stevengame.com", PORT = 30000, }, -- 高防-C
		},
	}
    -- 默认服务器配置
