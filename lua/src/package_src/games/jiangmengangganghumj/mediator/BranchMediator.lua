...
--Date
--此文件由[BabeLua]插件自动生成
local GamePlayLayer     = require("package_src.games.jiangmengangganghumj.games.ui.gamelayer.jiangmengangganghumjGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.jiangmengangganghumj.system.BranchSystemManager").new()
