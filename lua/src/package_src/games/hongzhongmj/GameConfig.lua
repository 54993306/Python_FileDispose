...
require("package_src.games.hongzhongmj.GameAudioConfig");

--是否支持用户自定义聊天
_gameUserChatTxt = true;
--游戏图标
-- _gameTitlePath = "package_res/games/hongzhongmj/image/title.png";

-- --大厅广告图
-- _gameHallAdPath = "package_res/games/hongzhongmj/image/ad_hall.png";

-- --红包广告
-- _gameRedpacketAdPath = "package_res/games/hongzhongmj/image/ad_redPacket.png";
...
GC_TurnLaiziPath_2 = "games/common/mj/games/laizijiaobiao.png"
