...
require("package_src.games.jiangmenguipaimj.GameAudioConfig");
...
-- 翻牌显示图片
GC_TurnLaiziPath = "package_res/games/jiangmenguipaimj/aniturncard/guipai.png"
--  麻将角标
GC_TurnLaiziPath_2 = "package_res/games/jiangmenguipaimj/aniturncard/icon_guipai.png"
...
if lIsMain then
    ...
    -- 大厅广告图
    _gameHallAdPath = "package_res/games/jiangmenguipaimj/advertisement/ad_hall.png"
    -- 红包广告
    _gameRedpacketAdPath = "package_res/games/jiangmenguipaimj/advertisement/ad_redPacket.png"
    -- 是否显示房卡
