...
local BranchGamePlayLayer = require("package_src.games.kaipingmj.games.ui.playlayer.BranchGamePlayLayer")
-- local GameUIView        = require ("package_src.games.kaipingmj.games.ui.gameover.changepoint")

 -- FriendOverView = require("package_src.games.kaipingmj.games.ui.gameover.kaipingmjFriendOverView")
local FanMaAnimation = require "package_src.games.kaipingmj.games.ui.fanma.FanMaAnimation"
local kaipingmjGameLayer = class("kaipingmjGameLayer", GameLayer)

function kaipingmjGameLayer:ctor()
...
-- @return void
--]]
function kaipingmjGameLayer:onShowUI()
...
function kaipingmjGameLayer:onGameStart()
    self.super.onGameStart(self)

end

function kaipingmjGameLayer:onGameResume()
    self.super.onGameResume(self)
    -- self:onFanMa()
end
function kaipingmjGameLayer:onFanMa()
    local maList = 
    {
        [1] = 
        {
...
function kaipingmjGameLayer:onAction()
...
function kaipingmjGameLayer:updatePlaydiffScore(operateData)
...
function kaipingmjGameLayer:drawdiffScoreAction(site,diffScore)
    local point = nil
    if diffScore < 0 then
...
function kaipingmjGameLayer:onGameOver()
    
    package.loaded["app.games.common.ui.gameover.FriendOverView"] = nil
    package.loaded["package_src.games.kaipingmj.games.ui.gameover.BranchFriendOverView"] = nil
    FriendOverView = require "package_src.games.kaipingmj.games.ui.gameover.BranchFriendOverView"
