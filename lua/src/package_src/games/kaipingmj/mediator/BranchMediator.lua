...
--Date
--此文件由[BabeLua]插件自动生成
 local GamePlayLayer     = require("package_src.games.kaipingmj.games.ui.gamelayer.kaipingmjGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.kaipingmj.system.BranchSystemManager").new()
