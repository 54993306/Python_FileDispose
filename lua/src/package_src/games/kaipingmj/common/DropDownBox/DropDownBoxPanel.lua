...
function DropDownBoxPanel:initTitle()
    ...
    --  字体路径
    local kFontFilePath = "package_res/games/kaipingmj/friendRoom/fangzhengcuyuan.TTF"
    --  标题
...
function DropDownBoxPanel:initOptions()
    local DropDownBox = require("package_src.games.kaipingmj.common.DropDownBox.DropDownBox")
