...
--============================================================
local GamePlayLayer     = require("package_src.games.shaoguanzpmj.ui.gamelayer.BranchGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.shaoguanzpmj.system.BranchSystemManager").new()
