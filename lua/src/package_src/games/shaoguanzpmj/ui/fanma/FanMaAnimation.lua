...
function FanMaAnimation:addCache()
   	cc.SpriteFrameCache:getInstance():addSpriteFrames("package_res/games/shaoguanzpmj/game/fangma.plist")
   	cc.SpriteFrameCache:getInstance():addSpriteFrames("package_res/games/shaoguanzpmj/game/fanmalight.plist")
end
...
function FanMaAnimation:drawFanMaText(bgLayer)
    local fmt = display.newSprite("package_res/games/shaoguanzpmj/game/fanma_text.png")
    fmt:addTo(bgLayer)
...
function FanMaAnimation:drawBg(index,rsNum)
    ...
    elseif self.m_quanma then
        local quanma = display.newSprite("package_res/games/shaoguanzpmj/game/quanma_text.png")
