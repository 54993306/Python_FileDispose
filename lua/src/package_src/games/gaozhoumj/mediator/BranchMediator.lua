...
--Date
--此文件由[BabeLua]插件自动生成
local GamePlayLayer     = require("package_src.games.gaozhoumj.games.ui.gamelayer.gaozhoumjGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.gaozhoumj.system.BranchSystemManager").new()
