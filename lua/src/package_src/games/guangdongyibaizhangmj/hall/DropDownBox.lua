...
function DropDownBox:initData()
    ...
    {
        BoxNormal = "package_res/games/guangdongyibaizhangmj/hall/selectInterface/drop_down_box_bg.png",
        IconNormal = "package_res/games/guangdongyibaizhangmj/hall/selectInterface/handle_down.png",
        IconShow = "package_res/games/guangdongyibaizhangmj/hall/selectInterface/handle_up.png",
    }
    --  文本参数
    self.m_parLabel =
    {
        ColorNormal = cc.c3b(0x2b,0x4c,0x01),
        ColorSelected = cc.c3b(0xff,0x00,0x00),
        FontSize = 28,
...
function DropDownBox:initUI()
    ...
    Log.i("self.m_currItem:getTag()...",self.m_currItem:getTag())
