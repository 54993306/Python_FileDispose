...
--Date
--此文件由[BabeLua]插件自动生成
 local GamePlayLayer     = require("package_src.games.guangdongyibaizhangmj.games.ui.gamelayer.guangdongyibaizhangmjGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.guangdongyibaizhangmj.system.BranchSystemManager").new()
