...
function DropDownBox:initData()
    ...
    {
        BoxNormal = "package_res/games/guangdongyibaizhangmj/friendRoom/drop_down_box_bg.png",
        IconNormal = "package_res/games/guangdongyibaizhangmj/friendRoom/handle_down.png",
        IconShow = "package_res/games/guangdongyibaizhangmj/friendRoom/handle_up.png",
    }
    --  文本参数
    self.m_parLabel =
    {
        ...
        FontSize = 28,
        FontName = "package_res/games/guangdongyibaizhangmj/friendRoom/fangzhengcuyuan.TTF",
    }
end
