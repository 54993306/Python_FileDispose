...
require("package_src.games.shanweimj.GameAudioConfig");
...
一、麻将用具
“来来宿州麻将”由条、饼、万、东南西北中發白、春夏秋冬、梅兰菊竹组成，合计144张牌。
...
-- @return table: {ch = "xx"}
-- function kGetPlayingInfoByTitle(title)
--     print("kGetPlayingInfoByTitle++++++++++++++",title)
