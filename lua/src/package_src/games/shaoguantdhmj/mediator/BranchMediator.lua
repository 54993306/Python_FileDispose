...
--============================================================
local GamePlayLayer     = require("package_src.games.shaoguantdhmj.ui.gamelayer.BranchGameLayer")
...
function BranchMediator:initGameModules()
    ...
    self.systemManager  = require("package_src.games.shaoguantdhmj.system.BranchSystemManager").new()
