...
function BranchGamePlaySystem:activate(context)
    self.myUserId = kUserInfo:getUserId() or 0
   	...
   	cc(self):addComponent("package_src.games.shaoguantdhmj.system.gameplay.BranchGameOverLogic"):exportMethods()
...
function BranchGamePlaySystem:deactivate()
  	...
  	cc(self):removeComponent("package_src.games.shaoguantdhmj.system.gameplay.BranchGameOverLogic")
