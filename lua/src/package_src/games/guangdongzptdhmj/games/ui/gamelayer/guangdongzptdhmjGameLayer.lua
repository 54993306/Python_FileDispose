...
--local GameUIView        = require ("package_src.games.guangdongzptdhmj.games.ui.gameover.changepoint")
local FanMaAnimation = require "package_src.games.guangdongzptdhmj.games.ui.fanma.FanMaAnimation"
--jmplayLayer = require("package_src.games.guangdongzptdhmj.games.ui.playlayer.BranchGamePlayLayer") ---- 翻马actionId

local guangdongzptdhmjGameLayer = class("guangdongzptdhmjGameLayer", GameLayer)
...
function guangdongzptdhmjGameLayer:ctor()
    self.super.ctor(self)
end

function guangdongzptdhmjGameLayer:onAction()
...
function guangdongzptdhmjGameLayer:updatePlayScore(operateData)
Log.i("guangdongzptdhmjGameLayer:updatePlayScore.........................",operateData)
    if operateData.actionID == enOperate.OPERATE_AN_GANG 
        ...
        Log.i("zptdhaction.....",operateData)
        local renshu = kFriendRoomInfo:getSelectRoomInfo()
        Log.i('zptdhdatas',renshu)
...
function guangdongzptdhmjGameLayer:drawScoreAction(site,score)
    local point = nil
    if score < 0 then
...
function guangdongzptdhmjGameLayer:onGameOver()
    package.loaded["app.games.common.ui.gameover.FriendOverView"] = nil
    package.loaded["package_src.games.guangdongzptdhmj.games.ui.gameover.guangdongzptdhmjFriendOverView"] = nil
    FriendOverView = require "package_src.games.guangdongzptdhmj.games.ui.gameover.guangdongzptdhmjFriendOverView"
    --self.super.onGameOver(self)
     local data = self.gameSystem:getGameOverDatas()
    Log.i("guangdongzptdhmjGameLayer:onGameOver............................................",data)
    assert(data ~= nil)
    --停止背景音乐
    audio.stopMusic()
...
-- function guangdongzptdhmjGameLayer:showGameOverUI(data, delayTime)
--     MJFanMa = require"package_src.games.guangdongzptdhmj.games.ui.MJFanMa"
--     --local MJFan = require"package_src.games.guangdongzptdhmj.games.ui.MJFanMac"
...
--             if v.showMa and v.showMa == 1 then

--             end
--         end
--         --Log.i("guangdongzptdhdatas",data)
--         local mafa = {}
...
--             --  if data.
--             if data.wi ==11 then
--                 MJFanMac = require"package_src.games.guangdongzptdhmj.games.ui.MJFanMac"
...
return guangdongzptdhmjGameLayer