...
local jieyangmjGameOverLogic = class("jieyangmjGameOverLogic", Component)
--[[
-- @brief  构造函数
-- @param  void
-- @return void
--]]
function jieyangmjGameOverLogic:ctor()
    jieyangmjGameOverLogic.super.ctor(self, "jieyangmjGameOverLogic")
end
--[
-- @brief  绑定
-- @param  void
-- @return void
--]
function jieyangmjGameOverLogic:onBind_()
	self.gameOverDatas = {}
end
...
-- @return void
--]
function jieyangmjGameOverLogic:onUnbind_()
	self.gameOverDatas = {}
end
...
-- @return void
--]]
function jieyangmjGameOverLogic:setGameOverDatas(cmd, context)
	--print("youxijieshu $$$$$$$$$$$$$")
	...
	for i=1, playerCount do
		...
		-- self.gameOverDatas.score[site].anGang 		= context.scI[index].anGangSum
		-- self.gameOverDatas.score[site].clearGang 		= context.scI[index].clearGangSum
		-- self.gameOverDatas.score[site].addGang 		= context.scI[index].addGangSum
        ...
        self.gameOverDatas.score[site].operateUserid	= context.scI[index].opCUI or {} --吃碰谁的牌
       	self.gameOverDatas.score[site].maCards          = context.scI[index].faI or {} --抓马
       	-- self.gameOverDatas.score[site].showMaCards      = context.scI[index].showMaCards or {}    --翻马
	...
	self.gameOverDatas.fanma = context.faI
end

--设置不同麻将玩家数据，可以给子类重写该方法
function jieyangmjGameOverLogic:setPlayerDatas(site,context)
   Log.i("overwrite chaozhoumjGameOverLogic:setPlayerDatas");
end
...
-- @return void
--]]
function jieyangmjGameOverLogic:getOverPlayerIndex(site, context)
...
-- @return void
--]]
function jieyangmjGameOverLogic:getGameOverDatas()
...
-- -- @return void
-- --]]
-- function chaozhoumjGameOverLogic:setWinerId(id)
-- 	self.winerId = id
-- end
...
-- -- @return void
-- --]]
-- function chaozhoumjGameOverLogic:getWinerId()
-- 	return self.winerId
-- end
...
-- @return void
--]]
function jieyangmjGameOverLogic:exportMethods()
	self:exportMethods_({
        "setGameOverDatas",
        "getGameOverDatas",
        "getWinerId",
