...
function DropDownBox:initData()
    ...
    {
        BoxNormal = "package_res/games/guangdongtuidaohumj/friendRoom/drop_down_box_bg.png",
        IconNormal = "package_res/games/guangdongtuidaohumj/friendRoom/handle_down.png",
        IconShow = "package_res/games/guangdongtuidaohumj/friendRoom/handle_up.png",
    }
    --  文本参数
    self.m_parLabel =
    {
