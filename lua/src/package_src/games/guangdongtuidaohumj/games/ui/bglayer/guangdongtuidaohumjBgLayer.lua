...
local guangdongtuidaohumjBgLayer=class("guangdongtuidaohumjBgLayer",bglayer)

function guangdongtuidaohumjBgLayer:ctor()
    self.mjNameScale = 0.7  -- 麻将名称字体缩放，三个字原大小会被落地的麻将挡住
    self.super.ctor(self);
end

function guangdongtuidaohumjBgLayer:addGameName()
...
return guangdongtuidaohumjBgLayer