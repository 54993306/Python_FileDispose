...
local DDZTWOPOtherHandCardView = require("package_src.games.paodekuai.pdktwop.mediator.widget.DDZTWOPOtherHandCardView")
...
local DDZTWOPMyHandCardView = require("package_src.games.paodekuai.pdktwop.mediator.widget.DDZTWOPMyHandCardView")
