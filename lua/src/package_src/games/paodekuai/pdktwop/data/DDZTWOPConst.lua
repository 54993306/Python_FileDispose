local DDZTWOPConst = require("package_src.games.paodekuai.pdkcommon.data.PokerDataConst")
...
--背景音乐
DDZTWOPConst.BGMUSICPATH = "package_res/games/pokercommon/music/audio/mp3/pdkEffect/bgm1.mp3"
...
DDZTWOPConst.VIEWPACKAGEPATH = {
    ["ROOMVIEW"] = "package_src.games.paodekuai.pdktwop.mediator.room.DDZTWOPRoom",
    ["GAMEOVERVIEW"] = "package_src.games.paodekuai.pdktwop.mediator.widget.DDZTWOPGameOverView",
    ["RULEVIEW"] = "package_src.games.paodekuai.pdkcommon.widget.PokerRoomRuleView",
    ["CHATVIEW"] = "package_src.games.paodekuai.pdkcommon.widget.PokerRoomChatView",
    ["DIALOGVIEW"] = "package_src.games.paodekuai.pdkcommon.widget.PokerRoomDialogView",
    ["SETTINGVIEW"] = "package_src.games.paodekuai.pdkcommon.widget.PokerRoomSettingView"
}
