...
function quickpaySelectPayType:onInit()
	...
	if Util.debug_shield_value("weixin") then
        ...
        if IsPortrait then -- TODO
            ...
            self.btnZfb:getLayoutParameter():setMargin({ left = display.cx - self.btnZfb:getContentSize().width/2, right = 0, top = self.labGoodDesc:getPositionY() + self.btnZfb:getContentSize().height/2 + 30, bottom = 0})
        end
    end
