...
enOperate = {
    ...
    OPERATE_GUO_SHOU_GANG = 15, -- 过手杠
    OPERATE_ZSZ = 20,--掷骰子
    OPERATE_REFRESH_PROP = 21,--刷新玩家数据
    OPERATE_GUANERTA = 22,--观二搭
	OPERATE_BU_HUA      = 23,   -- 补花
    OPERATE_MULT_FLOWER      = 24,   -- 多张补花
    OPERATE_XIAN_TIAN_TING      = 25,   -- 闲家天听
    ...
    OPERATE_JIA_PEI_ZI = 43, --架配子
    OPERATE_CLOCK_POINTER  = 50,	--用来在对局指示谁出牌}

    OPERATE_X3BAO = 80, -- 包三家
    OPERATE_X4FENG = 81, -- 四笔封牌

    OPERATE_YANGMA = 94, ---养马
    -- OPERATE_HUANPAI = 99, -- 换牌
}
if IsPortrait then -- TODO
    enOperate.OPERATE_ASK_BU_HUA    = 99  -- 问询补花
else
    enOperate.OPERATE_HUANPAI = 99 -- 换牌
end
...
enGameOverType =
{
    ...
    ERROR  	    = 4, -- 出错
    FANGHEIPAO  = 6, -- 放黑炮
    PENG_GANG_WAI_BAO    = 8, -- 碰杠外包
    HU_WAI_BAO    = 9, -- 胡牌外包
    QIANG_GANG_HU = 11, -- 抢杠胡
    GANG_HOU_PAO  = 12, -- 杠后炮
    GANG_KAI = 21, -- 杠开
    PAO_FENG  = 22, -- 跑风
    PAO_FENG_GANG = 23, -- 跑风杠
    DI_XIA_HU  = 33, -- 地下胡
};
