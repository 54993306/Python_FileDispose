...
function EmailContent:initListByText()
    ...
    local Panel_content = ccui.Helper:seekWidgetByName(self.widget,"Panel_content")
    local btn_butongyi = ccui.Helper:seekWidgetByName(Panel_content,"btn_butongyi")
    btn_butongyi:addTouchEventListener(handler(self,self.onClickButongyi))
    local btn_tongyi = ccui.Helper:seekWidgetByName(Panel_content,"btn_tongyi")
    btn_tongyi:addTouchEventListener(handler(self,self.onClickTongyi))

    local lab_tongyi = ccui.Helper:seekWidgetByName(Panel_content,"lab_tongyi")
...
function EmailContent:initPanelByData()
    ...
    if IsPortrait then -- TODO
        ...
        self.Panel_bg_content:addTouchEventListener(handler(self,self.onClickCallBack))
        ...
        btn_confirm_item:setVisible(not(#self.data.go > 0))
    end
