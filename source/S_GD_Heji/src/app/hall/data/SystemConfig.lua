...
--添加php活动数据的获取
function SystemConfig:getPHPActivityList()
    local activity = self:getDataByKe("php_activity_config")
    local phpVa = nil
    if activity and activity.va then
        phpVa = json.decode(activity.va)
    end
    return phpVa
end
