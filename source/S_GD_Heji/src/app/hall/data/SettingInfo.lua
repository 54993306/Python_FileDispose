...
-- 弹出日期
SettingInfo.getpopDay = function(self)
    return cc.UserDefault:getInstance():getStringForKey("popday", "")
end

-- 设置弹出日期
SettingInfo.setpopDay = function(self, popday)
    cc.UserDefault:getInstance():setStringForKey("popday", popday);
end
...
SettingInfo.setDDZGuidanceStatus = function(self, guidance_status)
    cc.UserDefault:getInstance():setIntegerForKey("gd_guidance_status", guidance_status)
    cc.UserDefault:getInstance():flush()
end
--获取斗地主引导状态
SettingInfo.getDDZGuidanceStatus = function(self)
    return cc.UserDefault:getInstance():getIntegerForKey("gd_guidance_status", 0)
end
