...
HallSocketCmd.CODE_REC_ACITVITY_JIESUAN = 60013;        --结算时收到的消息
-- 亲友圈
...
HallSocketCmd.CODE_FRIEND_ROOM_READY= 22008--type = 2,code=22008,  私有房准备 Client <--> Server
HallSocketCmd.CODE_RECV_FRIEND_ROOM_REWARD = 22009	--InviteRoomRankAward	 邀请房排行奖励
HallSocketCmd.CODE_PRIVATE_ROOM_SEATS_REQ = 22015	--InviteRoomInfo	 私有房玩家座位交换问询
