...
--    self:addCustomItem(listView, "点炮次数", tmpData.dp, dpPath)
  --杠的次数
  local gPath = tmpData.gangCount > 0 and "games/common/game/friendRoom/mjOver/total_win_tip_scale_bg.png" or "games/common/game/friendRoom/mjOver/total_fail_tip_scale_bg.png"
    self:addCustomItem(listView, "杠牌次数", tmpData.gangCount, gPath)
    
  
    --中马次数
    local mPath = tmpData.zhongmaCount > 0 and "games/common/game/friendRoom/mjOver/total_win_tip_scale_bg.png" or "games/common/game/friendRoom/mjOver/total_fail_tip_scale_bg.png"
    self:addCustomItem(listView, "中马总数", tmpData.zhongmaCount, mPath)
