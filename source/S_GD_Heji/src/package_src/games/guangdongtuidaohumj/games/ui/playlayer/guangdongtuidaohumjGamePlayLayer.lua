...
local guangdongtuidaohumjGamePlayLayer = class("guangdongtuidaohumjGamePlayLayer",GamePlayLayer)

function guangdongtuidaohumjGamePlayLayer:onAction()
	-- 显示吃碰杠摆放的牌
...
function guangdongtuidaohumjGamePlayLayer:runActionAnimation(operateData)
...
return guangdongtuidaohumjGamePlayLayer
