...
function DropItem:ctor(data)
    ...
    -- 载入UI
    self.m_pWidget = ccs.GUIReader:getInstance():widgetFromBinaryFile("package_res/games/zhongshanmj/friendRoom/down_item.csb")
...
function DropItem:initList(datas)
	for k,v in pairs(datas) do
	    ...
	    -- item:loadTextureNormal("package_res/games/zhongshanmj/friendRoom/button.png")
        item:setString(v)
        item:setFontSize(24)
