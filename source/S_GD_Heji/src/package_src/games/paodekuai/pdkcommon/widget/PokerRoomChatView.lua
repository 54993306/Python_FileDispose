...
function PokerRoomChatView:onEdit(event,pWidget)
     ...
     if EventType == ccui.TouchEventType.ended then
         ...
         if pWidget == self.btn_send then
             ...
             if content and content ~= "" then
                ...
                NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.PDKGameChatSend)
                self:keyBack();
             else
 ...
 function PokerRoomChatView:onClickChatText(pWidget, EventType)
     if EventType == ccui.TouchEventType.ended then
         ...
         NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.PDKGameChat..index)
         self:keyBack();
     end
 end
 ...
 function PokerRoomChatView:onClickChatFace(pWidget, EventType)
     if EventType == ccui.TouchEventType.ended then
         ...
         NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.PDKGameChatFace..index)
         Log.i("--wangzhi--face_index--",index)
