...
--local PokerSettingInfo = require("package_src.games.paodekuai.pdkcommon.data.PokerSettingInfo")
local PokerRoomSettingView = class("PokerRoomSettingView",PokerUIWndBase)

local settingViewPath ="package_src.games.paodekuai.pdkcommon.widget.PokerRoomSettingView"
