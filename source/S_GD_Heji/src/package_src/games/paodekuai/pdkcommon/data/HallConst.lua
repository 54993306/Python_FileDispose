...
CODE_TYPE_CHARGE_COIN = 7;			-- 兑换金币   (表示活动服的连接)
CODE_TYPE_MALL = 7;                 -- 兑换商城
CODE_TYPE_CHARGE = 9;              -- 充值
CODE_TYPE_CLUB = 10;              -- 亲友圈
if IS_IN_DATING_GAME then
    CODE_TYPE_GOLD_HALL = 1;		   -- 金币场大厅
    CODE_TYPE_GOLD_ROOM = 2;		   -- 金币场房间
    CODE_TYPE_GOLD_GAME = 3;		   -- 金币场对局
    CODE_TYPE_GOLD_PROP = 4;		   -- 金币场道具
    CODE_TYPE_GOLD_USER = 5;		   -- 金币场用户相关
else
    CODE_TYPE_GOLD_HALL = 1001;		   -- 金币场大厅
    CODE_TYPE_GOLD_ROOM = 1002;		   -- 金币场房间
    CODE_TYPE_GOLD_GAME = 1003;		   -- 金币场对局
    CODE_TYPE_GOLD_PROP = 1004;		   -- 金币场道具
    CODE_TYPE_GOLD_USER = 1005;		   -- 金币场用户相关
end
