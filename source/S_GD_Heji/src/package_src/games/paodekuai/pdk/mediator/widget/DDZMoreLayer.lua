...
--
-- 速配开始倒计时
require("package_src.games.paodekuai.pdkcommon.widget.PokerUIWndBase")
require("package_src.games.paodekuai.pdkcommon.widget.PokerUIManager")
require("package_src.games.paodekuai.pdkcommon.sound.PokerSoundPlayer")
require("package_src.games.paodekuai.pdkcommon.widget.PokerTouchCaptureView")
...
function DDZMoreLayer:onClicked(pWidget, EventType)
	...
	if IsPortrait then
    	...
    	if pWidget == self.btn_setting then
            ...
            NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.PDKGameSetting)
        ...
        elseif pWidget == self.btn_rule then
            ...
            NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.PDKGameRuleButton)
    	end
