...
function BranchGameOverLogic:setGameOverDatas(cmd, context)
   ...
   sys:setMjDistrubuteEnd(false)
    ...
    for i=1, playerCount do
        ...
        self.gameOverDatas.score[site].fanma = context.scI[index].fanMaCards
        self.gameOverDatas.score[site].zhongma = context.scI[index].zhongMaCards
    end

    self.gameOverDatas.maList = context.maList
    self.gameOverDatas.fanMaShow = context.fanMaShow
