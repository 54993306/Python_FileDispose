...
PokerCommonSocketCmd.CODE_USERDATA_POINT 		= 1003;	 --更新玩家钻石
...
PokerCommonSocketCmd.CODE_REC_SUPPLEMENTCOIN  	= 30035; --补充钻石
...
PokerCommonSocketCmd.CODE_REC_ACITVITY_JIESUAN = 60013;        --结算时收到的消息
