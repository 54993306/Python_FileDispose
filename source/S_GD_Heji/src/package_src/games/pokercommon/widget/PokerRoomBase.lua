...
local PokerCommonSocketCmd = require("package_src.games.pokercommon.data.PokerCommonSocketCmd")
   ...
   local data = {}
    ...
    --[[
        ...
        if self._selectBtn.agree == false then
            ...
            NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.DDZGameAskDismiss)
    ...
    data.cancelCallback = function()
        Log.i("--wangzhi--UmengClickEvent.DDZGameContinue--")
        NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.DDZGameContinue)
    end
