...
function PokerRoomChatView:onEdit(event,pWidget)
     ...
     if EventType == ccui.TouchEventType.ended then
         ...
         if pWidget == self.btn_send then
             ...
             if content and content ~= "" then
                ...
                NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.DDZGameChatSend)
                self:keyBack();
             else
 ...
 function PokerRoomChatView:onClickChatText(pWidget, EventType)
     if EventType == ccui.TouchEventType.ended then
         ...
         NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.DDZGameChat..index)
         self:keyBack();
     end
 end
 ...
 function PokerRoomChatView:onClickChatFace(pWidget, EventType)
     if EventType == ccui.TouchEventType.ended then
         ...
         NativeCall.getInstance():NativeCallUmengEvent(UmengClickEvent.DDZGameChatFace..index)
