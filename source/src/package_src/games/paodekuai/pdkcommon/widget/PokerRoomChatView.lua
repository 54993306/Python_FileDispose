...
function PokerRoomChatView:onEdit(event,pWidget)
     ...
     if EventType == ccui.TouchEventType.ended then
         ...
         if pWidget == self.btn_send then
             ...
             if content and content ~= "" then
                ...
                NativeCallUmengEvent(UmengClickEvent.PDKGameChatSend)
                self:keyBack();
             else
 ...
 function PokerRoomChatView:onClickChatText(pWidget, EventType)
     if EventType == ccui.TouchEventType.ended then
         ...
         NativeCallUmengEvent(UmengClickEvent.PDKGameChat..index)
         self:keyBack();
     end
 end
 ...
 function PokerRoomChatView:onClickChatFace(pWidget, EventType)
     if EventType == ccui.TouchEventType.ended then
         ...
         NativeCallUmengEvent(UmengClickEvent.PDKGameChatFace..index)
