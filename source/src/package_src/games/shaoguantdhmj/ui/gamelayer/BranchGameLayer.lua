...
local GamePlayLayer     = require "package_src.games.shaoguantdhmj.ui.playlayer.BranchGamePlayLayer"
...
local FanMaAnimation = require "package_src.games.shaoguantdhmj.ui.fanma.FanMaAnimation"
...
function BranchGameLayer:onGameOver()
    ...
    package.loaded["package_src.games.shaoguantdhmj.ui.gameover.BranchFriendOverView"] = nil
    FriendOverView = require "package_src.games.shaoguantdhmj.ui.gameover.BranchFriendOverView"
