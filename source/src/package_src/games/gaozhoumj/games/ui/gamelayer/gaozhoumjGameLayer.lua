...
--local GameUIView        = require ("package_src.games.gaozhoumj.games.ui.gameover.changepoint")
--FriendOverView = require ("app.games.huainanmj.games.ui.gameover.huainanmjFriendOverView")
jmplayLayer = require("package_src.games.gaozhoumj.system.playlayer.BranchGamePlayLayer")
local FanMaAnimation = require "package_src.games.gaozhoumj.games.ui.fanma.FanMaAnimation"
local gaozhoumjGameLayer = class("gaozhoumjGameLayer", GameLayer)

function gaozhoumjGameLayer:ctor()
...
-- @return void
--]]
function gaozhoumjGameLayer:onShowUI()
    self.super.onShowUI(self)
    self:createGameUIView()
end

function gaozhoumjGameLayer:createGameUIView()
--     --绘制游戏界面ui
...
function gaozhoumjGameLayer:onAction()
...
--function gaozhoumjGameLayer:updatePlayScore(operateData)
--Log.i("gaozhoumjGameLayer:updatePlayScore.........................",operateData)
...
--        if operateData.actionID == enOperate.OPERATE_AN_GANG then
...
--    end
--end
--function gaozhoumjGameLayer:drawScoreAction(site,score)
--    local point = nil
--    if score < 0 then
...
function gaozhoumjGameLayer:onGameOver()
    
    package.loaded["app.games.common.ui.gameover.FriendOverView"] = nil
    package.loaded["package_src.games.gaozhoumj.games.ui.gameover.gaozhoumjFriendOverView"] = nil
    FriendOverView = require "package_src.games.gaozhoumj.games.ui.gameover.gaozhoumjFriendOverView"
    ...
    Log.i("gaozhoumjGameLayer:onGameOver............................................",data)
    assert(data ~= nil)
    --停止背景音乐
    audio.stopMusic()
