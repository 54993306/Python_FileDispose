...
--    end
--    --  字体路径
--    local kFontFilePath = "package_res/games/gaozhoumj/CheckBoxPanel/fangzhengcuyuan.TTF"
--    --  标题
...
--    local kCSBFilePath = "package_res/games/gaozhoumj/CheckBoxPanel/CheckBoxPanel.csb"
